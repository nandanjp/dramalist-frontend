        ...
        <Tile className="sm:col-span-2 lg:col-span-1 lg:row-span-2">
            ...
            <div className="divide-y divide-slate-50 px-5">
                {MOCK_SHOWS.slice(0, visible).map((show) => (
                    <div key={show.title} className="animate-fade-up flex items-center gap-3 py-3">
                        ...
                        <span
                            className={`shrink-0 rounded-full px-2 py-0.5 text-[10px] font-medium ${STATUS_COLORS[show.status]}`}
                        >
                            {show.status}
                        </span>
...
const REVIEW_TEXT =
    "The chemistry between the leads is absolutely unmatched. One of the most re-watchable shows ever made — every scene feels alive with feeling.";
...
const AI_PICKS = [
    {
        title: "Mr. Sunshine",
        reason: "Sweeping historical epic with the same emotional depth you love.",
    },
        ...
        <Tile>
            ...
            <div className="space-y-2 p-4">
                {AI_PICKS.slice(0, visible).map((pick) => (
                    <div key={pick.title} className="animate-fade-up rounded-xl bg-slate-50 p-3">
        ...
        <Tile>
            ...
            <div className="p-4">
                <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-full bg-linear-to-br from-violet-500 to-purple-600 text-sm font-bold text-white">
                        N
                    </div>
                    <div>
