    ...
    return (
        <div className="mx-2 flex w-52 shrink-0 flex-col gap-2 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
            <div className="flex items-start justify-between gap-2">
                ...
                <span className="shrink-0 text-xs font-bold text-violet-600">★ {drama.rating}</span>
            </div>
...
export function DramaMarquee() {
    ...
    return (
        <div className="relative overflow-hidden py-4">
            ...
            {/* Row 2 — right */}
            <div className="animate-marquee-reverse mt-3 flex hover:[animation-play-state:paused]">
                {doubled2.map((d, i) => (
